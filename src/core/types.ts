...
export interface Scene {
  ...
  beats?: SequenceBeat[];
  /** Choreography for component-based sequences. Controls when components
   *  appear, move, and exit across beats. Generated by the planner or
   *  auto-derived from beats + components. */
  choreography?: Array<{
    label: string;
    startTime: number;
    duration: number;
