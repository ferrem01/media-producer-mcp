...
(function() {
  ...
  function loadTexture(imgElement, unit) {
    ...
    // Flip Y on upload: WebGL texture origin is bottom-left but images are
    // top-left, and the gl-transitions shaders sample assuming the flip. Without
    // this the frames render UPSIDE DOWN for the whole transition.
