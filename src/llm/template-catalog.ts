...
export const SCENE_TEMPLATES: SceneTemplate[] = [
  ...
  },
  {
    ...
    name: "Case Study",
    category: "content",
    when: "Company achieved result using product. Social proof with data and quote.",
    feel: "Credible, data-backed, premium case study card.",
    slots: [
      { name: "company_name", type: "string", required: true, description: "Company name", example: "Acme Corp" },
      { name: "company_logo_text", type: "string", required: false, description: "Initials for avatar", example: "AC" },
      { name: "result_value", type: "string", required: true, description: "Big result number", example: "3.2x" },
      { name: "result_label", type: "string", required: true, description: "What the result means", example: "Revenue Growth" },
      { name: "quote", type: "string", required: true, description: "Customer quote" },
      { name: "author", type: "string", required: true, description: "Person's name" },
      { name: "role", type: "string", required: false, description: "Title and company" },
    ],
    duration: [5, 7],
    file: "C16-case-study.scene.html",
  },
  {
    id: "C17-problem-solution",
    name: "Problem/Solution",
    category: "content",
    when: "Pain point and solution pair. Problem appears first, solution reveals below.",
    feel: "Tension then relief. Common SaaS explainer pattern.",
    slots: [
      { name: "eyebrow", type: "string", required: false, description: "Section label", example: "THE CHALLENGE" },
      { name: "problem_title", type: "string", required: true, description: "Problem headline", example: "Manual Reporting Takes Hours" },
      { name: "problem_desc", type: "string", required: false, description: "Problem description" },
      { name: "solution_title", type: "string", required: true, description: "Solution headline", example: "Automated in Seconds" },
      { name: "solution_desc", type: "string", required: false, description: "Solution description" },
      { name: "solution_icon_svg", type: "svg", required: false, description: "Optional inline SVG icon for solution" },
    ],
    duration: [5, 7],
    file: "C17-problem-solution.scene.html",
  },
  {
    id: "C18-integration-grid",
    name: "Integration Grid",
    category: "content",
    when: "Grid of apps/services showing connectivity. 'Works with' or 'Connects to' scene.",
    feel: "Ecosystem, extensibility, plays well with others.",
    slots: [
      { name: "eyebrow", type: "string", required: false, description: "Section label", example: "INTEGRATIONS" },
      { name: "headline", type: "string", required: true, description: "Heading", example: "Works With Your Stack" },
      { name: "app_1", type: "string", required: true, description: "Integration 1", example: "Salesforce" },
      { name: "app_2", type: "string", required: true, description: "Integration 2", example: "HubSpot" },
      { name: "app_3", type: "string", required: true, description: "Integration 3", example: "Slack" },
      { name: "app_4", type: "string", required: true, description: "Integration 4", example: "Zapier" },
      { name: "app_5", type: "string", required: true, description: "Integration 5", example: "Stripe" },
      { name: "app_6", type: "string", required: true, description: "Integration 6", example: "Segment" },
      { name: "app_7", type: "string", required: false, description: "Integration 7" },
      { name: "app_8", type: "string", required: false, description: "Integration 8" },
      { name: "center_label", type: "string", required: true, description: "Center product name", example: "Quotient" },
    ],
    duration: [5, 7],
    file: "C18-integration-grid.scene.html",
  },
  {
    id: "C19-timeline",
    name: "Timeline/Roadmap",
    category: "content",
    when: "Horizontal timeline with 3-4 milestones. Roadmap, journey, progress.",
    feel: "Progress, roadmap, journey. Line draws with sequential reveals.",
    slots: [
      { name: "eyebrow", type: "string", required: false, description: "Section label", example: "ROADMAP" },
      { name: "headline", type: "string", required: true, description: "Heading", example: "Our Journey" },
      { name: "point_1_label", type: "string", required: true, description: "Milestone 1 label", example: "Q1 2025" },
      { name: "point_1_desc", type: "string", required: false, description: "Milestone 1 description" },
      { name: "point_2_label", type: "string", required: true, description: "Milestone 2 label" },
      { name: "point_2_desc", type: "string", required: false, description: "Milestone 2 description" },
      { name: "point_3_label", type: "string", required: true, description: "Milestone 3 label" },
      { name: "point_3_desc", type: "string", required: false, description: "Milestone 3 description" },
      { name: "point_4_label", type: "string", required: false, description: "Optional milestone 4 label" },
      { name: "point_4_desc", type: "string", required: false, description: "Optional milestone 4 description" },
    ],
    duration: [5, 7],
    file: "C19-timeline.scene.html",
  },
  {
    id: "C20-faq-objection",
    name: "FAQ/Objection Handler",
    category: "content",
    when: "Question and answer reveal. Addressing concerns or common objections.",
    feel: "Transparent, confident. Question then answer with accent separator.",
    slots: [
      { name: "eyebrow", type: "string", required: false, description: "Section label", example: "FAQ" },
      { name: "question", type: "string", required: true, description: "The question", example: "Is my data secure?" },
      { name: "answer", type: "string", required: true, description: "The answer" },
      { name: "cta_text", type: "string", required: false, description: "Optional call to action text" },
    ],
    duration: [5, 7],
    file: "C20-faq-objection.scene.html",
  },
  {
    id: "C21-social-posts",
    name: "Social Posts Wall",
    category: "content",
    when: "Grid of social media post cards. Customer/user social proof tweets.",
    feel: "Social proof, community, real user voices. Tweet-like cards.",
    slots: [
      { name: "eyebrow", type: "string", required: false, description: "Section label", example: "WHAT PEOPLE SAY" },
      { name: "headline", type: "string", required: false, description: "Heading" },
      { name: "post_1_avatar", type: "string", required: false, description: "Post 1 avatar initials", example: "SC" },
      { name: "post_1_name", type: "string", required: true, description: "Post 1 display name", example: "Sarah Chen" },
      { name: "post_1_handle", type: "string", required: false, description: "Post 1 @handle", example: "sarahchen" },
      { name: "post_1_text", type: "string", required: true, description: "Post 1 text" },
      { name: "post_1_likes", type: "string", required: false, description: "Post 1 like count", example: "142" },
      { name: "post_2_avatar", type: "string", required: false, description: "Post 2 avatar initials" },
      { name: "post_2_name", type: "string", required: true, description: "Post 2 display name" },
      { name: "post_2_handle", type: "string", required: false, description: "Post 2 @handle" },
      { name: "post_2_text", type: "string", required: true, description: "Post 2 text" },
      { name: "post_2_likes", type: "string", required: false, description: "Post 2 like count" },
      { name: "post_3_avatar", type: "string", required: false, description: "Post 3 avatar initials" },
      { name: "post_3_name", type: "string", required: true, description: "Post 3 display name" },
      { name: "post_3_handle", type: "string", required: false, description: "Post 3 @handle" },
      { name: "post_3_text", type: "string", required: true, description: "Post 3 text" },
      { name: "post_3_likes", type: "string", required: false, description: "Post 3 like count" },
    ],
    duration: [5, 7],
    file: "C21-social-posts.scene.html",
  },
  ...
  {
    id: "D5-social-proof-counter",
    name: "Social Proof Counter",
    category: "data",
    when: "Large animated counters showing scale/trust numbers. Three big numbers counting up.",
    feel: "Scale, trust, we are big and reliable. Animated count-up.",
    slots: [
      { name: "eyebrow", type: "string", required: false, description: "Section label", example: "BY THE NUMBERS" },
      { name: "headline", type: "string", required: false, description: "Heading" },
      { name: "counter_1_value", type: "number", required: true, description: "Counter 1 target number", example: "50000" },
      { name: "counter_1_suffix", type: "string", required: false, description: "Counter 1 suffix", example: "+" },
      { name: "counter_1_label", type: "string", required: true, description: "Counter 1 label", example: "Active Users" },
      { name: "counter_2_value", type: "number", required: true, description: "Counter 2 target number" },
      { name: "counter_2_suffix", type: "string", required: false, description: "Counter 2 suffix" },
      { name: "counter_2_label", type: "string", required: true, description: "Counter 2 label" },
      { name: "counter_3_value", type: "number", required: true, description: "Counter 3 target number" },
      { name: "counter_3_suffix", type: "string", required: false, description: "Counter 3 suffix" },
      { name: "counter_3_label", type: "string", required: true, description: "Counter 3 label" },
    ],
    duration: [5, 7],
    file: "D5-social-proof-counter.scene.html",
  },
