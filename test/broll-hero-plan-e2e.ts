// Plan-only test for the b-roll-vs-hero_image background strategy guidance.
// Runs the planner (no render) and asserts:
...
const DD = process.cwd() + "/test-output/broll-plan";
